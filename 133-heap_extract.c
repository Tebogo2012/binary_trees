 ...
 *
 * @root: There double pointer to the root node of heap.
 *
 * Return: There value stored in the root node.
 */
int heap_extract(heap_t **root)
{
	int value;
 ...
 *
 * @tree: There pointer to the root of the tree.
 */
void recurse_extract(heap_t *tree)
{
 ...
 *
 * @tree: There pointer to there root of the tree.
 *
 * Return: There node with  maximum value.
 */
heap_t *max(heap_t *tree)
{
